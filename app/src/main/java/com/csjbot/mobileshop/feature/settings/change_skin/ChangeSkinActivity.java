package com.csjbot.mobileshop.feature.settings.change_skin;
...
public class ChangeSkinActivity extends BaseModuleActivity {
    ...
    public int getLayoutId() {
        return getCorrectLayoutId(R.layout.activity_setting_change_skin, R.layout.vertical_activity_setting_change_skin);
    }
    ...
    private void initRecycleView() {
        ...
        changeSkinAdapter.setOnRecyclerViewItemClickListener((view, position) -> {
