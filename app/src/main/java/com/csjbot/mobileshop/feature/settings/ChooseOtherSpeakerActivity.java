...
public class ChooseOtherSpeakerActivity extends BaseModuleActivity {
    ...
    class SpeakViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            checkBox.setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                if (SharedPreUtil.putString(SharedKey.SPEAKERVOICE, language_key, CsjLanguage.getISOLanguage(CsjLanguage.CURRENT_LANGUAGE))
    ...
    public void afterViewCreated(Bundle savedInstanceState) {
        ...
        language_key = CsjLanguage.getISOLanguage(CsjLanguage.CURRENT_LANGUAGE) + GoogleSpechImpl.TTS_LANGUAGE_NAME;
        country_key = CsjLanguage.getISOLanguage(CsjLanguage.CURRENT_LANGUAGE) + GoogleSpechImpl.TTS_COUNTRY_NAME;
        speaker_key = CsjLanguage.getISOLanguage(CsjLanguage.CURRENT_LANGUAGE) + GoogleSpechImpl.TTS_VOICE_NAME;
        language = SharedPreUtil.getString(SharedKey.SPEAKERVOICE, language_key, CsjLanguage.getISOLanguage(CsjLanguage.CURRENT_LANGUAGE));
