...
public class NaviSettingActivity extends BaseModuleActivity implements NaviSettingContract.View, View.OnClickListener {
    ...
    private static final int MAX_NAVI_NAME = 50;
    ...
    public int getLayoutId() {
        return Constants.isPlus() ? R.layout.vertical_activity_navi_setting : R.layout.activity_navi_setting;
...
//        CheckOutUtil.getInstance().verifyUseName(etNaviDescription, this,REGEX_USERNAME);
    ...
    private void initCheckBox() {
        cbMusic.setOnCheckedChangeListener((compoundButton, b) -> {
        ...
        cbImage.setOnCheckedChangeListener((compoundButton, b) -> {
    ...
    public void onResume() {
        ...
        if (!TextUtils.equals(Constants.Scene.CurrentScene, Constants.Scene.JiChangScene)) {
...
//            mPresenter.uploadMap();
    ...
    private void initListener() {
        ...
        etNaviName.addTextChangedListener(new MaxLengthWatcher(this, MAX_NAVI_NAME, etNaviName, getString(R.string.navi_name_length_limit)));
        etNaviNickName.addTextChangedListener(new MaxLengthWatcher(this, MAX_NAVI_NAME, etNaviNickName, getString(R.string.navi_nick_length_limit_2)));
        etNaviDescription.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                etNaviDescription.addTextChangedListener(textChangedWatch(etNaviDescription, MAX_NAVI_NAME, getString(R.string.navi_arrive_length_limit)));
                return true;
            }
        });
        etNaviStartTip.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                etNaviStartTip.addTextChangedListener(naviStartWatch(etNaviStartTip, MAX_NAVI_NAME, getString(R.string.navi_start_length_limit)));
                return true;
            }
        });
        etNaviArrive.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                etNaviArrive.addTextChangedListener(naviArriveWatch(etNaviArrive, MAX_NAVI_NAME, getString(R.string.navi_arrive_tip_length_limit)));
                return true;
            }
        });
    }
...
//            msg = getString(R.string.plz_input_navi_aname);
    ...
    private void startGlobalNotice() {
        com.csjbot.mobileshop.model.http.factory.ServerFactory.createNoticeSerivce().getGlobalAnnouncement(ProductProxy.SN, new Observer<NoticeBean>() {
            @Override
