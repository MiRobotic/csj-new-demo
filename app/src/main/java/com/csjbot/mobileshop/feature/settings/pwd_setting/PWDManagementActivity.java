package com.csjbot.mobileshop.feature.settings.pwd_setting;
...
public class PWDManagementActivity extends BaseModuleActivity implements PWDManagementContract.view {
    ...
    public int getLayoutId() {
        return getCorrectLayoutId(R.layout.activity_pwd_setting, R.layout.vertical_activity_pwd_setting);
    }
