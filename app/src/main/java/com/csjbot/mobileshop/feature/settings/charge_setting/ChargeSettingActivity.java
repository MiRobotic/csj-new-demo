package com.csjbot.mobileshop.feature.settings.charge_setting;
...
public class ChargeSettingActivity extends BaseModuleActivity implements ChargeSettingContract.view {
    ...
    public int getLayoutId() {
        return getCorrectLayoutId(R.layout.activity_charge_setting, R.layout.vertical_activity_charge_setting);
    }
