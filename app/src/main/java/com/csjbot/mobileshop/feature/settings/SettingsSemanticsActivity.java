...
public class SettingsSemanticsActivity extends BaseModuleActivity {
    ...
    public int getLayoutId() {
        return getCorrectLayoutId(R.layout.activity_settings_semantics, R.layout.vertical_activity_settings_semantics);
    }
    ...
    public void ok() {
        ...
        ServerFactory.createApi().updateChatAndSegment(json, new Observer<ResponseBody>() {
            ...
            public void onError(Throwable throwable) {
                getLog().error("语义闲聊网络错误: " + throwable.getMessage());
