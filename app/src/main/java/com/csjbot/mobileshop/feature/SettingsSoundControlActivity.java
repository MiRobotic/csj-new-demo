package com.csjbot.mobileshop.feature;
...
public class SettingsSoundControlActivity extends BaseModuleActivity {
    ...
    public int getLayoutId() {
        return Constants.isPlus() ? R.layout.vertical_activity_settings_navi_sound_control : R.layout.activity_settings_navi_sound_control;
    }
    ...
    public void init() {
        ...
        if (!TextUtils.isEmpty(resumeJson)) {
            ArrayList<String> resumeList = new Gson().fromJson(pauseJson, new TypeToken<ArrayList<String>>() {
            }.getType());
        ...
        if (!TextUtils.isEmpty(endJson)) {
            ArrayList<String> endList = new Gson().fromJson(pauseJson, new TypeToken<ArrayList<String>>() {
            }.getType());
