package com.csjbot.mobileshop.model.tcp.body_action;
...
public class BodyActionImpl extends BaseImpl implements IAction {
    ...
    public void nodAction() {
        if (BuildConfig.robotType.equals(BuildConfig.ROBOT_TYPE_DEF_ALICE)
                ...
                || BuildConfig.robotType.equals(BuildConfig.ROBOT_TYPE_DEF_ALICE_PLUS_i18n)
                || BuildConfig.robotType.equals(BuildConfig.ROBOT_TYPE_DEF_ALICE_i18n)) {
