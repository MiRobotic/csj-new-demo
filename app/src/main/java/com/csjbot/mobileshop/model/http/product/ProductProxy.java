package com.csjbot.mobileshop.model.http.product;
...
import com.csjbot.mobileshop.cart.entity.RobotSpBean;
...
import com.csjbot.mobileshop.model.http.bean.ProductInfo;
import com.csjbot.mobileshop.model.http.bean.SceneBean;
import com.csjbot.mobileshop.model.http.bean.SceneRepuestBean;
import com.csjbot.mobileshop.model.http.product.listeners.BaseBackstageListener;
import com.csjbot.mobileshop.model.http.product.listeners.ContentListListener;
import com.csjbot.mobileshop.model.http.product.listeners.ContentTypeListListener;
import com.csjbot.mobileshop.model.http.product.listeners.EvalutionListener;
import com.csjbot.mobileshop.model.http.product.listeners.IProduct;
import com.csjbot.mobileshop.model.http.product.listeners.MenuListListener;
import com.csjbot.mobileshop.model.http.product.listeners.ObtainData;
import com.csjbot.mobileshop.model.http.product.listeners.OrderCodeUrlListener;
import com.csjbot.mobileshop.model.http.product.listeners.SpListListener;
import com.csjbot.mobileshop.model.http.workstream.Logo;
...
public class ProductProxy extends ProductParent implements IProduct, ObtainData {
    ...
    public void getRobotMenuList(MenuListListener listener) {
        ...
        if (ISUPDATA || productInfo == null) {
            //清空所有产品信息缓存
            removeMenuList();
            removeSpList(CsjLanguage.getISOLanguage(CsjLanguage.CURRENT_LANGUAGE));
            getRobotMenuList(SN, CsjLanguage.getISOLanguage(CsjLanguage.CURRENT_LANGUAGE), new Observer<RobotMenuListBean>() {
                @Override
    ...
    public synchronized void robotSpList(String menuid, Context context, SpListListener listener) {
        ...
        if (ISUPDATA) {
            ...
            removeSpList(SharedKey.SP_LAN.getLanguageStr(CsjLanguage.getISOLanguage(CsjLanguage.CURRENT_LANGUAGE)));
            NEED_LOAD = 0;
    ...
    public <T> void saveList(T bean, T listener, String parent_id) {
        if (bean instanceof RobotMenuListBean) {
            ...
            if (SharedPreUtil.putString(SharedKey.PRODUCT_MENU_LIST,
                    SharedKey.MENU_LAN.getLanguageStr(CsjLanguage.getISOLanguage(CsjLanguage.CURRENT_LANGUAGE)), robotMenuListBean)) {
            ...
            // 将json字符串存入到本地
            if (SharedPreUtil.putString(SharedKey.SP_LAN.getLanguageStr(CsjLanguage.getISOLanguage(CsjLanguage.CURRENT_LANGUAGE)),
            ...
            if (SharedPreUtil.putString(SharedKey.CONTENT_NAME,
                    SharedKey.CONTENT_LAN.getLanguageStr(CsjLanguage.getISOLanguage(CsjLanguage.CURRENT_LANGUAGE)), contentBean)) {
            ...
            // 将json字符串存入到本地
            if (SharedPreUtil.putString(SharedKey.CONTENT_LAN.getLanguageStr(CsjLanguage.getISOLanguage(CsjLanguage.CURRENT_LANGUAGE)),
    ...
    public void getScene(BaseBackstageListener listener) {
        ...
        getScene(body, new Observer<SceneBean>() {
            ...
            public void onNext(@NonNull SceneBean sceneBean) {
                CsjlogProxy.getInstance().info("getScene:onNext:json" + new Gson().toJson(sceneBean));
...
//        String lan = CsjLanguage.getLanguageStr2();
...
//        });
    ...
    @Override
    public void getClothColor(String sn, Observer<ClothColorBean> observer) {
        iProduct.getClothColor(sn, observer);
    }
}
