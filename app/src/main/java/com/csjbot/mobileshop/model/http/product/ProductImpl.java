...
public class ProductImpl extends BaseImpl implements IProduct, ObtainData {
    ...
    public RobotMenuListBean getMenuList() {
        String lan = SharedKey.MENU_LAN.getLanguageStr(CsjLanguage.getISOLanguage());
    ...
    public RobotSpListBean getSpList(String menuid) {
        String lan = SharedKey.SP_LAN.getLanguageStr(CsjLanguage.getISOLanguage());
    ...
    public ContentBean getContent() {
        String lan = SharedKey.CONTENT_LAN.getLanguageStr(CsjLanguage.getISOLanguage());
    ...
    public void getClothColor(String sn, Observer<ClothColorBean> observer) {
        scheduler(getRetrofit().getClothColor(sn)).subscribe(observer);
    }
