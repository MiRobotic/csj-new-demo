...
import com.csjbot.mobileshop.service.UpdateAppService;
import com.csjbot.mobileshop.util.SharedKey;
import com.csjbot.mobileshop.util.SharedPreUtil;
import com.csjbot.mobileshop.util.SharedPreferencesSDUtil;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.bt_chinese:
                showLanguage(CsjLanguage.CHINESE, true);
            ...
            case R.id.bt_english:
                showLanguage(CsjLanguage.ENGELISH_US, true);
                SharedPreUtil.putInt(SharedKey.LANGUAGEMODE_NAME, SharedKey.LANGUAGEMODE_KEY, CsjLanguage.ENGELISH_US);
                BRouter.toHome();
                finish();
                break;
            case R.id.bt_japanese_selected:
            case R.id.bt_japanese:
                showLanguage(CsjLanguage.JAPANESE, true);
                SharedPreUtil.putInt(SharedKey.LANGUAGEMODE_NAME, SharedKey.LANGUAGEMODE_KEY, CsjLanguage.ENGELISH_US);
                BRouter.toHome();
                finish();
                break;
