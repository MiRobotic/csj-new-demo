...
public class SharedKey {
    ...
    public static final String PATROL_POINT_KEY = "PATROL_POINT_KEY";
    public static final String PATROL_POINT_NAME = "PATROL_POINT_NAME";
    public static final String PATROL_PLAN_KEY = "PATROL_PLAN_KEY";
    public static final String PATROL_PLAN_NAME = "PATROL_PLAN_NAME";
    public static final String PATROL_LINE_KEY = "PATROL_LINE_KEY";
    public static final String PATROL_LINE_NAME = "PATROL_LINE_NAME";
    ...
    public static final String LANGUAGEMODE_KEY = "LANGUAGEMODE_KEY";//int
    public static final String LANGUAGE_NAME_KEY = "LANGUAGE_NAME_KEY";//String
    ...
    public static final String REBOOTTIME = "REBOOTTIME";// 没有进入 主屏幕的次数
    public static final String REBOOTTIME_KEY = "REBOOTTIME_KEY";
     ...
     * 机器人默认问候语
     */
    public static final String ROBOT_DEFAULT_GREET_CONTENT = "ROBOT_DEFAULT_GREET_CONTENT";

    // baidu 设置
    public static final String BAIDU_WIFI_NAME = "BAIDU_WIFI";
    public static final String BAIDU_WIFI_SSID_KEY = "BAIDU_WIFI_SSID";
    public static final String BAIDU_WIFI_PWD_KEY = "BAIDU_WIFI_PWD";
