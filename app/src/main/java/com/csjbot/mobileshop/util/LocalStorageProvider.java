 ...
 * @create_time : 2018/1/29.
 * @Package_name: BlackGaGa
 * Storage Access Framework存储访问框架
 */
...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        row.add(DocumentsContract.Root.COLUMN_TITLE, "内部存储");
        ...
        row.add(DocumentsContract.Root.COLUMN_ICON, R.drawable.ic_launcher_round);
