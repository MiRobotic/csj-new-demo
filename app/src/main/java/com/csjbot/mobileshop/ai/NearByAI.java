package com.csjbot.mobileshop.ai;
...
public class NearByAI extends AI<NearByActivity>{
        ...
        switch (intent){
            ...
            case BUS_STATION:
                if (TextUtils.equals(Constants.Scene.CurrentScene,"lvyou")) {
                    activity.goPoiSearchAct("公交车站");
                }
                break;
            case SHARABLE_CHARGE:
                if (TextUtils.equals(Constants.Scene.CurrentScene,"lvyou")) {
                    activity.goPoiSearchAct("共享充电宝");
                }
                break;
            case PARK:
                if (TextUtils.equals(Constants.Scene.CurrentScene,"lvyou")) {
                    activity.goPoiSearchAct("停车场");
                }
                break;
            case HOSPITAL:
                if (TextUtils.equals(Constants.Scene.CurrentScene,"lvyou")) {
                    activity.goPoiSearchAct("医院");
                }
                break;
            default:
                break;
    ...
    static class AIParams{
        ...
        //旅游
        static final String[] BUS_STATION = {"GONGJIAOCHEZHAN"};
        static final String[] SHARABLE_CHARGE = {"CHONGDIANBAO","GONGXIANGCHONGDIANBAO"};
        static final String[] PARK = {"TINGCHECHANG"};
        static final String[] HOSPITAL = {"YIYUAN"};
        ...
        static {
            ...
            //旅游
            datas.add(new Object[][]{BUS_STATION,{Intent.BUS_STATION}});
            datas.add(new Object[][]{SHARABLE_CHARGE,{Intent.SHARABLE_CHARGE}});
            datas.add(new Object[][]{PARK,{Intent.PARK}});
            datas.add(new Object[][]{HOSPITAL,{Intent.HOSPITAL}});
        }
    ...
    public enum Intent{
        ...
        ,BUS_STATION,SHARABLE_CHARGE,PARK,HOSPITAL   //旅游场景
    }
}
