...
import com.csjbot.mobileshop.chat_handle.HandleProblemFactory;
import com.csjbot.mobileshop.chat_handle.constans.Constants;
import com.csjbot.mobileshop.core.RobotManager;
import com.csjbot.mobileshop.feature.navigation.NaviActivity;
import com.csjbot.mobileshop.feature.settings.ProductSNActivity;
import com.csjbot.mobileshop.feature.take_number.TakeNumberActivity;
import com.csjbot.mobileshop.localbean.DeviceInfo;
...
public class TestActivity extends BaseFullScreenActivity {
    ...
    public void init() {
        ...
        RobotManager.getInstance().addListener((OnDeviceInfoListener) info -> {
            ...
            intent.putExtra(com.csjbot.mobileshop.global.Constants.DOWN_PLATE, deviceInfo.getDownPlate());
            intent.putExtra(com.csjbot.mobileshop.global.Constants.UP_PLATE, deviceInfo.getUpPlate());
            intent.putExtra(com.csjbot.mobileshop.global.Constants.UP_COMPUTER, deviceInfo.getUpComputer());
            intent.putExtra(com.csjbot.mobileshop.global.Constants.NAV, deviceInfo.getNav());
            startActivity(intent);
        });

        mRobotManager.addListener((OnSetSNListener) resp -> {
