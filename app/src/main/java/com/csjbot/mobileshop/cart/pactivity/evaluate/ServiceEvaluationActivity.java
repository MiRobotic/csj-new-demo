package com.csjbot.mobileshop.cart.pactivity.evaluate;
...
import com.csjbot.mobileshop.ai.ServiceEvaluationAI;
...
import com.csjbot.mobileshop.util.ShopcartUtil;
...
public class ServiceEvaluationActivity extends BaseModuleActivity implements ServiceEvaluationContract.view {
    ...
    protected void onResume() {
        super.onResume();
        getChatView().clear();
        getChatView().addRobotNormalChat(getString(R.string.service_evaluation));
