...
/**
 * 重写Banner {@link com.youth.banner.Banner}
 * 使下标支持换肤
 *
 * @author ShenBen
 * @date 2019/1/28 9:26
...
public class MyBanner extends FrameLayout implements OnPageChangeListener {
    private static final String TAG = MyBanner.class.getSimpleName();
    ...
    private int mIndicatorSelectedResId = R.drawable.iv_point_selected;
    private int mIndicatorUnselectedResId = R.drawable.iv_point_unselected;
    private int mLayoutResId = R.layout.layout_my_banner;
    ...
    private List<SkinCompatImageView> indicatorImages;
    private Context context;
    private BannerViewPager viewPager;
    private TextView bannerTitle, numIndicatorInside, numIndicator;
    private LinearLayout indicator, indicatorInside, titleView;
    private SkinCompatImageView bannerDefaultImage;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorSelectedResId = typedArray.getResourceId(R.styleable.MyBanner_banner_indicator_drawable_selected, R.drawable.iv_point_selected);
        mIndicatorUnselectedResId = typedArray.getResourceId(R.styleable.MyBanner_banner_indicator_drawable_unselected, R.drawable.iv_point_unselected);
        scaleType = typedArray.getInt(R.styleable.MyBanner_banner_image_scale_type, scaleType);
        ...
        mLayoutResId = typedArray.getResourceId(R.styleable.MyBanner_banner_layout_id, mLayoutResId);
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.MyBanner_banner_image_default, R.drawable.no_banner);
        typedArray.recycle();
    }
    ...
    private void createIndicator() {
        ...
        for (int i = 0; i < count; i++) {
            SkinCompatImageView imageView = new SkinCompatImageView(context);
