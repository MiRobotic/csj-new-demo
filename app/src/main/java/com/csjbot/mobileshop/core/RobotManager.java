package com.csjbot.mobileshop.core;
...
public class RobotManager {
    ...
    public void addListener(OnSNListener listener) {
        robot.addSnListener(listener);
    }

    public void removeSnListener(OnSNListener listener) {
        robot.removeSnListener(listener);
    }
    ...
    public void setCustomerStateListener(OnCustomerStateListener listener) {
        robot.setOnCustomerStateListener(listener);
    }
    /**
     * 热词接收回调
     *
    ...
    public void removeListener(OnWakeupListener listener) {
        robot.removeWakeupListener(listener);
    }
    ...
    public void addListener(OnHeadTouchListener listener) {
        robot.addHeadTouchListener(listener);
    }

    public void removeListener(OnHeadTouchListener listener) {
        robot.removeHeadTouchListener(listener);
    }
    ...
    public void setListener(OnDetectPersonListener listener) {
        robot.setDetectPersonListener(listener);
    }

    public void addListener(OnDetectPersonListener listener) {
        robot.addDetectPersonListener(listener);
    }

    public void removeListener(OnDetectPersonListener listener) {
        robot.removeDetectPersonListener(listener);
    }
    ...
    public void addListener(OnMakeSessionIdListener listener) {
        robot.setMakeSessionIdListener(listener);
    }
