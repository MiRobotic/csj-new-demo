...
public class ClientReqProxy implements
    ...
    public void navi(String json) {
        CsjlogProxy.getInstance().info("NAVI->机器人下发点: " + json);
    ...
    public void hangUpHumanService(String sn) {
        customServiceReq.hangUpHumanService(sn);
    }

    @Override
    public void sendHumanServiceHeartBeat(String sn) {
        customServiceReq.sendHumanServiceHeartBeat(sn);
    }
